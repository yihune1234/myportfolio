...
export const portfolioData: PortfolioData = {
  personal: {
    ...
    tagline:
      "Building scalable backend systems, robust APIs, and cross-platform experiences. Focused on architecture, performance, and clean code.",
  ...
  summary:
    "Software engineer based in Addis Ababa, Ethiopia. Currently pursuing Software Engineering at Haramaya University, building production systems and digital infrastructure. Specializes in backend systems, API architecture, and scalable digital infrastructure.",
  about: {
    description:
    ...
    highlights: [
      {
        ...
        description:
          "Scalable backend systems, RESTful APIs, and responsive frontends built with modern architectures.",
      },
      {
        title: "Systems Thinker",
        description:
          "Designing distributed, fault-tolerant systems with clean separation of concerns.",
      },
      {
        title: "Security Focused",
        description:
          "Implementing auth, encryption, and secure API patterns across the stack.",
      },
      {
  ...
  services: [
    {
      ...
      description:
        "End-to-end web application development using React, TypeScript, Node.js, and modern frameworks. From database design to responsive UI.",
    },
    {
      title: "API Design & Development",
      description:
        "RESTful and GraphQL API architecture, documentation, and implementation with authentication, rate limiting, and caching.",
    },
    {
      title: "Backend Systems Engineering",
      description:
        "Scalable server-side applications, microservices architecture, database optimization, and cloud deployment.",
    },
    {
      title: "Mobile App Development",
      description:
        "Cross-platform mobile applications using React Native with native performance and responsive design.",
    },
    {
      title: "DevOps & Cloud Infrastructure",
      description:
        "CI/CD pipeline setup, Docker containerization, cloud deployment (AWS/Render), and infrastructure automation.",
    },
    {
      title: "Technical Consulting",
      description:
        "Architecture review, system design consultation, technology stack recommendations, and code quality assessment.",
    },
  ],
  contact: {
    email: "yihunebelay859@gmail.com",
...
Study Areas: ${edu.studyAreas.join(", ")}`);
  ...
  if (
    ...
    const serviceText = portfolioData.services
...
The contact form on the portfolio website can be used to send a message directly.`);
  ...
  if (
    ...
    const highlightText = portfolioData.about.highlights
