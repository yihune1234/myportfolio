...
export default function HeroSection({
  ...
  return (
    <section
      id="home"
      className="min-h-screen pt-24 pb-12 px-4 sm:px-6 lg:px-8 flex items-center"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="animate-fadeInDown">
            <div className="mb-6">
              <h1 className="text-5xl md:text-6xl font-bold mb-4">
                <span className="gradient-text">Yihune Belay</span>
              </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <button
                ...
                className="px-8 py-3 bg-gradient-to-r from-primary to-secondary text-white rounded-lg font-semibold hover:shadow-lg hover:shadow-primary/50 transition-all duration-300 flex items-center justify-center gap-2 group"
              >
                Let's Work Together
          ...
          <div className="animate-fadeInUp flex justify-center lg:justify-end">
            <div className="relative">
              ...
              {/* Floating badges */}
              <div className="absolute -bottom-4 -left-4 bg-white dark:bg-card p-4 rounded-xl shadow-xl border border-border animate-slideInRight">
              ...
              <div className="absolute -top-4 -right-4 bg-white dark:bg-card p-4 rounded-xl shadow-xl border border-border animate-slideInRight">
                <p className="text-sm font-semibold text-foreground">
                  Backend Specialist
                </p>
                <p className="text-xs text-muted-foreground">
